...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "h-9 w-full min-w-0 rounded-[var(--radius-sm)] bg-bg-elevated px-3 py-1 text-base shadow-[inset_0_0_0_1px_var(--border-secondary),0_1px_4px_-1px_var(--shadow-drop-2)] transition-[color,box-shadow] outline-none md:text-sm",
