...
const RECENT_DOCS = [
  ...
  },
  {
    ...
    status: "Shared",
    author: "Created by You",
    gradient: "from-[#f38181] to-[#fce38a]",
  },
  {
    title: "Engineering Team Offsite - Planning Deck",
    status: "In Drafts",
    author: "Created by You",
    gradient: "from-[#355c7d] to-[#6c5b7b]",
  },
]
...
function SideNavItem({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "flex w-full items-center gap-2 rounded-lg p-2 text-sm leading-[1.43] transition-colors",
        active
    ...
    >
      ...
      <span className={cn("truncate", active && "text-text-primary")}>{label}</span>
    </button>
  )
}
...
function DocumentCard({
  ...
  return (
    <div className="relative flex flex-col overflow-hidden rounded-[10px] bg-bg-elevated pt-0.5 px-0.5 shadow-elevation-1 transition-shadow hover:shadow-elevation-3">
...
function HomeContent() {
  return (
    <>
      {/* ── Header section ─────────────────────────────────────── */}
      <section className="flex flex-col gap-6 border-b border-border-secondary px-6 pb-6 pt-4">
        <div className="text-2xl leading-[1.3] tracking-[-0.24px]">
          <p className="text-text-tertiary">
            Great work on your last deck, John.
          </p>
          <p className="text-text-primary">What will you create next?</p>
        </div>
        <ActionCardsRow />
      </section>
      ...
      <section className="p-6">
        <div className="flex flex-col gap-4">
          <h2 className="text-xl font-medium leading-none text-text-primary">
            Recent
          </h2>
  ...
  return (
    <div className="flex h-screen flex-col bg-bg-secondary">
      ...
      <header className="flex h-14 shrink-0 items-center justify-between overflow-hidden">
        ...
        <div className="flex w-[260px] flex-col items-start justify-center px-3 py-2">
          <Popover open={wsMenuOpen} onOpenChange={setWsMenuOpen}>
            <PopoverTrigger asChild>
              <button className="flex w-full cursor-pointer items-center gap-2 rounded-xl py-[3px] pl-1 pr-1.5 transition-colors hover:bg-bg-elevated-hover">
                {/* Avatar */}
                ...
                {/* Text */}
                <div className="flex flex-1 flex-col gap-0.5 text-xs font-medium leading-[1.33] w-full">
                  <span className="text-text-primary text-left">Foursquare</span>
                  <span className="text-text-brand text-left">Enterprise plan</span>
                </div>
                {/* Dropdown caret */}
                <div className="flex items-center rounded-md bg-[rgba(26,26,26,0.06)] p-1">
                  <CaretDown
                    weight="bold"
                    className={cn(
            ...
            <PopoverContent
              align="start"
              sideOffset={4}
              className="flex w-61 overflow-hidden px-0 py-2 flex-col gap-2 rounded-xl bg-bg-elevated shadow-elevation-3"
            >
              {/* Inner shadow overlay */}
        ...
        <div className="flex items-center gap-5 px-6 py-3">
          ...
          <div className="size-7 overflow-hidden rounded-full border-[1.5px] border-white bg-paids-neutral-300">
      ...
      <div className="relative mx-0 flex min-h-0 flex-1 overflow-hidden rounded-2xl bg-bg-secondary pt-1 pr-1 pb-1 shadow-elevation-2">
